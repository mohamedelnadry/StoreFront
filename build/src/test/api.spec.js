...
describe("test user api", () => {
  it("GET request to test users endoint with invalid token", () =>
  ...
  it("GET request to show users with valid token ", () =>
    __awaiter(void 0, void 0, void 0, function* () {
  ...
  it("GET request to show 1 user by id ", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const response = yield req
        .get(`/user/${userID}`)
...
describe("test products api", () => {
  it("GET request to get all products", () =>
    __awaiter(void 0, void 0, void 0, function* () {
  ...
  it("POSR request to create product", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const response = yield req
  ...
  it("GET request to view 1 product", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const response = yield req
...
describe("test create order api", () => {
  it("POST request to test create_orders", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const response = yield req
        .post("/order")
        .set("Authorization", token)
