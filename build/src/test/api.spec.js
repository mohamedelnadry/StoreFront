...
describe("test user api", () => {
    ...
    it("test user endoint with invalid token", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("show users with valid token ", () => __awaiter(void 0, void 0, void 0, function* () {
...
describe("test products api", () => {
    const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTAsImlhdCI6MTY3MTIzMjk4MH0.4TqjPvHtNENdcYX4j_X6E962Tpr0uMAKkZC00LQ2hDM";
    it("test all products ", () => __awaiter(void 0, void 0, void 0, function* () {
...
describe("test create order api", () => {
    const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTAsImlhdCI6MTY3MTIzMjk4MH0.4TqjPvHtNENdcYX4j_X6E962Tpr0uMAKkZC00LQ2hDM";
    it("test orders", () => __awaiter(void 0, void 0, void 0, function* () {
