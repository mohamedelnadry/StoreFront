...
describe("test user models defined", () => {
    ...
    it("test view all users functionality", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("test view 1 user functionality", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("test Login user defined", () => __awaiter(void 0, void 0, void 0, function* () {
...
describe("test products models defined", () => {
    ...
    it("test create products functionality", () => __awaiter(void 0, void 0, void 0, function* () {
        const products = {
            name: "apple watch",
            price: 1500,
        };
    ...
    it("test view all product functionality", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("test view 1 product functionality", () => __awaiter(void 0, void 0, void 0, function* () {
